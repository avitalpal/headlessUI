               ...
               <ul class="space-y-2">
                  ...
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/menupage" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Menu Playground</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/switchpage" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Switch Playground</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/transitpage" class="flex-1 ml-3 hover:text-violet-600 whitespace-pre-wrap truncate">Transition Playground</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/extrapage" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Extras Playground</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="https://www.notion.so/wizteam/Headless-UI-81f102880b084780a589139f50f315c2" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">HeadlessUI Doc</Link>
                     </div>
                  </li>
               </ul>
            </div>
